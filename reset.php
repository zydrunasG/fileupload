	...
	if(!isset($error)){
      ...
      // Emailas:
        ...
        try{
            ...
            include  'includes/mailsettings.php'; // va tep?
            ...
            // send to:
            $mail->addAddress($to, "zmogau");
            // send email
            $mail->isHTML(true);
            $mail->Subject = $subject;
            $mail->Body = $body;
            $mail->AltBody = strip_tags($body); // tiem kas naudojasi debiliskom email sistemom

            $mail->send();  // most important thing
