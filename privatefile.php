...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <h3 class="text-center">Please select file to upload to private</h3>
            <form method="post" action="privateupload.php" autocomplete="off" enctype="multipart/form-data">
...
<script>
    removeClass();
    document.getElementById("li-privatefile").classList.add("active");
</script>
